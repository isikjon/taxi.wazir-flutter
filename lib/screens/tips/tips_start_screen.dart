      ...
      child: Column(
        ...
        children: [
          _buildSection(
            ...
            [
              'Если у вас возникли технические проблемы или появились вопросы по работе с сервисом вы всегда можете написать в службу поддержки через соответствующий раздел меню в Wazir. Сотрудники службы поддержки помогут вам в любой ситуации - например, если:',
